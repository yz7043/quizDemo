...
public class Constant {
    ...
    public static final String ADMIN_QUIZ_RESULT_SORT_CATEGORY = "adminQuizResultSortCategory";
    public static final String ADMIN_QUIZ_RESULT_SORT_FULLNAME = "adminQuizResultSortFullname";
